...
export default {
  ...
  mounted() {
    ...
    this.$root.$on("updateInfo", data => {
      ...
      this.animal.breed = data.breed;
      this.animal.size = data.size;
      this.animal.color = data.color;
      this.animal.age = data.age;
      this.animal.gender = data.gender;
      this.animal.is_sterilised = data.is_sterilised;
      this.animal.cage_id = data.cage_id;
    });
  },
  methods: {
    saveForm() {
